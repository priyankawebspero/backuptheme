...
(function() {
    ...
    SocialLogin = function() {
        ...
        var iframeHtml = "\u003Ciframe\u000Aid\u003D\u0022one\u002Dclick\u002Dsocial\u002Dlogin\u002Dbuttons\u003C\u003Ciframe_container_id\u003E\u003E\u0022 class\u003D\u0022one\u002Dclick\u002Dsocial\u002Dlogin\u002Dbuttons\u0022\u000AframeBorder\u003D\u00270\u0027\u000Astyle\u003D\u0027   margin\u002Dtop: 10px\u003B   width: 100%\u003B overflow: hidden\u003B\u0027\u000Adata\u002Ddefault_style\u003D\u0027margin\u002Dtop: 10px\u003B overflow: hidden\u003B width: 100%\u003B\u0027\u000Aallowtransparency\u003D\u0027yes\u0027 src\u003D\u0027https://oneclicksociallogin.devcloudsoftware.com/api/socialbuttons/?cache_key\u003D7684118327\u0026shop\u003Dplumgoodness\u002D2.myshopify.com\u0026popup_type\u003D\u0026current_url\u003D\u003C\u003Ccurrent_url\u003E\u003E\u0026iframe_id\u003D\u003C\u003Ciframe_id\u003E\u003E\u0027\u000A\u003E\u000A\u003C/iframe\u003E";
        var share_bar = "";
        ...
        if (window.location.href.indexOf("login") === -1 && window.location.href.indexOf("register") === -1 && window.location.href.indexOf("oneclick/validateaccount") === -1 && window.location.href.indexOf("oneclick/updateemailaccount") === -1 && window.location.href.indexOf("oneclick/updateaccount") === -1) {
                ...
                if (!!document.referrer && isLoginPage() && !isLoginPage(document.referrer) && !isAppPage(document.referrer)) {
                    var redirect_login_url = document.referrer;
                } else {
                    var redirect_login_url = null;
                }
        ...
        var showPopup = function() {
            ...
            if (!SOCIAL_LOGIN_CUSTOMER_LOGGED_IN) {
                ...
                setTimeout(function() { loginPopup() }, 2*1000);
        ...
        var _init = function() {
                ...
                if (isLoginPage() && !isAddressesPage() && !isChallengePage()) {
        ...
        var listenIframeEvent = function() {
            ...
            eventer(messageEvent, function(e) {
                ...
                if (data.event == "one_click_social_login") {
                    ...
                    location.href = "https://plumgoodness-2.myshopify.com" + data.data.location;
                }
                    ...
                    if (data.data.location.indexOf("http") !== -1) {
                        ...
                        var url = "https://plumgoodness-2.myshopify.com" + data.data.location;
                    }
